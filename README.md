...
This is a basic **Digital Clock** built using React.js
...
npm start
```
This will start a server in your localhost which will automatically open the Digital Clock application into your browser.
